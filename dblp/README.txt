...
Included are snapshots of conferences:
	FSE, FASE, ICMT, MoDELS, PLDI, POPL, SLE
	(they are just generated by filter.py and pretty-printed for indentation purposes)
	(filter.xslt would do the same job as filter.py if there was an XSLT processor capable of dealing with large XMLs)
